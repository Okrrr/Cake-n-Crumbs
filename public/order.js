...
function processOrder() {
    ...
    const isDelivery = document.querySelector('.option[data-type="delivery"]').classList.contains('active');
    const address = isDelivery ? document.getElementById('delivery-address').value : '';
    
    // In a real application, you would send this data to your server
    console.log('Order Details:', {
        customer: { name, email, phone, password: password || 'No account created' },
    ...
    alert(`Thank you for your order, ${name}! Your order has been placed successfully. You will receive a confirmation email shortly.`);
